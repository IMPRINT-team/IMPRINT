...
const AdminEvents = () => {
    ...
    return(
        ...
        <div className="bg-gradient-to-r from-neutral to-base">
                      ...
                      <tbody className="bg-primary">
                        {events.map((event) => (
                          <tr key={event.id} className="bg-base-300 hover:bg-gradient-to-br hover:from-primary/10 hover:via-secondary/20 hover:to-neutral/10">
                            ...
                            <td className="text-center py-3 px-2"><button type="button" id="btnUpdateEvent" className={`${baseLinkClasses} me-2`}>Update Event</button><button type="button" id="btnDeleteEvent" className={errLinkClasses}>Delete Event</button></td>
                          </tr>
                        ))}
                      </tbody>
                    </table>
